...
- (void) directorDidReshapeProjection:(CCDirector *)director
{
	if (director.runningScene == nil)
    {
        ...
        // clear UserDefaults
        //[kStandartUserDefaults removePersistentDomainForName:[[NSBundle mainBundle] bundleIdentifier]];
        ...
        else
        {
            ...
            // Launching AdWhirl
            if (kDevicePhone) [kLGAdWhirl initAdWhirlWithOrientation:UIInterfaceOrientationMaskLandscape];
            else [kLGAdWhirl initAdWhirlWithOrientation:UIInterfaceOrientationMaskPortrait];
        }
